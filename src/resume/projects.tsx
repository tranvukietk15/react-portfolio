...
function Projects() {
	const data = [
		...
		},
		{
			...
			technologies: `NodeJS (Nestjs), .Net 7, Duende Identity, OAuth2, SQL, MongoDb,
		...
		},
		{
			...
			technologies: `Typescript, .Net 6, SQL, ReactJS, S3, Onion Architeture, Docker, nginx,
			jenkins.`,
			contributed: [
				`Init project and apply clean architecture.`,
		...
		},
		{
			...
			team leader and PM.`,
			technologies: `Typescript, EF core 3.1, GraphQL, microservice, ReactJS, AWS services,
